...
A lab staff member can view a list of all equipment currently on loan.

The current-loans list clearly shows the borrower and due date for each item.

A reminder is generated for a borrower before an equipment loan becomes overdue.

Another person can test each selected backlog item and confirm that it works as described.